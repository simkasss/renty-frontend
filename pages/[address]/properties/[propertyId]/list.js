...
export default function listProperty() {
    ...
    async function listProperty(_description, _propertyNftId, _rentalTerm, _rentalPrice, _depositAmount, _hash) {
        provider = new ethers.providers.Web3Provider(ethereum)
        signer = provider.getSigner()
        userAddress = await signer.getAddress()
        rentAppAddress = networkMapping["11155111"].RentApp[0]
        ...
        const propertyTx = await contract.listProperty(_description, _propertyNftId, _rentalTerm, _rentalPrice, _depositAmount, _hash)
                ...
                <div>
                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubmit} className="form">
                            ...
                            <label>
                                Hash of Rent Contract Terms and Conditions:
